...
mod legacy_platform_adapter_cleanup_tests {
    ...
    fn matches_orphaned_legacy_platform_adapter() {
        let line = " 1359     1 /Users/user/.antigravity_cockpit/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
    ...
    fn ignores_non_orphaned_or_current_processes() {
        let line = " 1359 1805 /Users/user/.antigravity_cockpit/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
            orphaned_legacy_platform_adapter_pid_from_ps_line(line, 99999),
            None
        );

        let current_line = " 1359 1 /Users/user/.antigravity_cockpit/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
...
mod tests {
    ...
    fn trae_windows_scan_candidates_match_exact_platform_dirs() {
        let trae = Path::new(r"C:\Users\User\AppData\Local\Programs\Trae\Trae.exe");
        let trae_cn = Path::new(r"C:\Users\User\AppData\Local\Programs\Trae CN\Trae CN.exe");
        let solo_cn =
            Path::new(r"C:\Users\User\AppData\Local\Programs\TRAE SOLO CN\TRAE SOLO CN.exe");
