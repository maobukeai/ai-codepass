...
pub const PLATFORM_QODER_CN: &str = "qoder_cn";
...
pub const PLATFORM_WORKBUDDY_AI: &str = "workbuddy_ai";

pub const SUPPORTED_PLATFORM_IDS: [&str; 10] = [
    PLATFORM_CODEBUDDY,
    PLATFORM_CODEBUDDY_CN,
    PLATFORM_WORKBUDDY,
    PLATFORM_WORKBUDDY_AI,
    PLATFORM_QODER,
    PLATFORM_QODER_CN,
    PLATFORM_TRAE,
    PLATFORM_TRAE_SOLO,
    ...
    vec![
        TrayLayoutGroup {
            ...
            platform_ids: vec![
                ...
                PLATFORM_WORKBUDDY_AI.to_string(),
            ],
...
fn normalize_platform_id(id: &str) -> Option<&'static str> {
    match id.trim() {
        ...
        PLATFORM_QODER_CN | "qoder-cn" => Some(PLATFORM_QODER_CN),
