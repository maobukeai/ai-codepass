...
// AI CodePass 独立数据目录
const DATA_DIR: &str = ".ai_codepass";
const DEV_DATA_DIR: &str = ".ai_codepass_dev";
const DATA_DIR_ENV: &str = "AI_CODEPASS_DATA_DIR";
const PROFILE_ENV: &str = "AI_CODEPASS_PROFILE";
...
pub fn get_data_dir() -> Result<PathBuf, String> {
    ...
    for key in [
        "AI_CODEPASS_TEST_DATA_DIR",
        "AI_CODEPASS_DATA_DIR",
