...
use super::*;
    ...
    fn sample_account() -> TraeAccount {
        TraeAccount {
            ...
            email: "trae-test@example.com".to_string(),
            user_id: Some("1000000000000000001".to_string()),
            nickname: Some("Trae User".to_string()),
            tags: None,
            ...
            trae_profile_raw: Some(serde_json::json!({
                "Result": {
                    ...
                    "NonPlainTextEmail": "trae-test@example.com",
