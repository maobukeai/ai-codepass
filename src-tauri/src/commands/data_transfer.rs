...
fn load_instance_store_by_platform(platform: &str) -> Result<InstanceStore, String> {
    match platform {
        ...
        "qoder_cn" => modules::qoder_instance::load_instance_store_cn(),
        "qwenwork" => modules::qoder_instance::load_instance_store_qwenwork(),
...
fn save_instance_store_by_platform(platform: &str, store: &InstanceStore) -> Result<(), String> {
    match platform {
        ...
        "qoder_cn" => modules::qoder_instance::save_instance_store_cn(store),
        "qwenwork" => modules::qoder_instance::save_instance_store_qwenwork(store),
