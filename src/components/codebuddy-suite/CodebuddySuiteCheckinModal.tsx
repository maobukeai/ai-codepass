...
// 便捷导出：WorkBuddy AI (国际版) 签到弹窗
export function WorkbuddyAiCheckinModal({
  accounts,
  onClose,
  onCheckinComplete,
}: {
  ...
  return (
    <CodebuddySuiteCheckinModal
      accounts={accounts}
      getCheckinStatus={workbuddyAiService.getCheckinStatusWorkbuddyAi}
      performCheckin={workbuddyAiService.checkinWorkbuddyAi}
      getDisplayEmail={getAccountDisplayEmail}
      onClose={onClose}
      onCheckinComplete={onCheckinComplete}
    />
