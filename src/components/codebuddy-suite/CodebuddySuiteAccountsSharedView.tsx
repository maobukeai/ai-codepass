...
import { QuickSettingsPopover, type QuickSettingsType } from "../QuickSettingsPopover";
      ...
      {showAddModal &&
        createPortal(
          <div className="modal-overlay account-add-modal-overlay">
            <div
              className={`modal modal-content ghcp-add-modal platform-account-add-modal ${platformConfig.pageClassName}-add-modal${
